...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>Pg Spotter|| PG Response</title>
...
<?php			
$id=$_SESSION['pgasuid'];
$ret=mysqli_query($con,"select tblbookpg.Id as bookid,tblbookpg.BookingNumber,tblbookpg.BookingDate,tblbookpg.CheckinDate,tblbookpg.Status,tblpg.PGTitle from tblbookpg join tblpg on tblpg.id=tblbookpg.Pgid where Userid='$id'");
$cnt=1;
